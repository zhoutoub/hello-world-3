function totalR=calcRwLmd(lmd,DatePrice,startI,endI)
%this function takes lmd as an input, and will be used in fminsearch
%startI and endI 指离最大指标有多远，比如过去一年就输入-251,0
